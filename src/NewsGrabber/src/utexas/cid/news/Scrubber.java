 ...
 * i.e., remove boilerplate HTML, ads, etc.
 * article
 * @author Ryan Golden
 *
 */
public class Scrubber {
	...
	/**
	 * Returns the main content (e.g., news article text) for a given URL.  If there is
	 * an error, an exception is printed to stderr and empty string is returned.
	 * @param pUrlString - string containing URL with content to extract
	 * @return String of main content (non HTML)
	 * @throws MalformedURLException
	 */
	public static String getContent(String pUrlString) throws MalformedURLException {
		URL myUrl = new URL(pUrlString);
		try {
			return ArticleExtractor.INSTANCE.getText(myUrl);			
		} catch (BoilerpipeProcessingException e) {
			System.err.println("Problem getting and cleaning content for url: " + pUrlString);
			e.printStackTrace();
		}
		return "";
	}
